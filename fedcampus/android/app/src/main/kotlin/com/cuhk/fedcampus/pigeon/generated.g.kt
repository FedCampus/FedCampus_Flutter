    ...
    companion object {
        ...
        fun setUp(binaryMessenger: BinaryMessenger, api: HuaweiAuthApi?) {
            run {
                val channel = BasicMessageChannel<Any?>(
                    binaryMessenger,
                    "dev.flutter.pigeon.fedcampus.HuaweiAuthApi.getAuthenticate",
                    codec
                )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel = BasicMessageChannel<Any?>(
                    binaryMessenger,
                    "dev.flutter.pigeon.fedcampus.HuaweiAuthApi.cancelAuthenticate",
                    codec
                )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
    ...
    companion object {
        ...
        fun setUp(binaryMessenger: BinaryMessenger, api: TrainFedmcrnn?) {
            ...
            run {
                val channel = BasicMessageChannel<Any?>(
                    binaryMessenger,
                    "dev.flutter.pigeon.fedcampus.TrainFedmcrnn.getParameters",
                    codec
                )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel = BasicMessageChannel<Any?>(
                    binaryMessenger,
                    "dev.flutter.pigeon.fedcampus.TrainFedmcrnn.updateParameters",
                    codec
                )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
            ...
            run {
                val channel = BasicMessageChannel<Any?>(
                    binaryMessenger,
                    "dev.flutter.pigeon.fedcampus.TrainFedmcrnn.trainingSize",
                    codec
                )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
