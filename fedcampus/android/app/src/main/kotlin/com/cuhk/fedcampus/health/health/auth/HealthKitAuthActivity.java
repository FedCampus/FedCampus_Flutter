...
public class HealthKitAuthActivity extends Activity {
    ...
    private static int scopeLength;
    ...
    private void requestAuth() {
        ...
        String[] scopes = new String[]{
                ...
                //calorie save and write
                Scopes.HEALTHKIT_CALORIES_READ, Scopes.HEALTHKIT_CALORIES_WRITE,
                ...
                // View and save the high intensity exercise time
                Scopes.HEALTHKIT_STRENGTH_READ, Scopes.HEALTHKIT_STRENGTH_WRITE,
                // view and save the distance data
                Scopes.HEALTHKIT_DISTANCE_READ, Scopes.HEALTHKIT_DISTANCE_WRITE,
                // sleep time
                Scopes.HEALTHKIT_SLEEP_READ, Scopes.HEALTHKIT_SLEEP_WRITE,

                Scopes.HEALTHKIT_STRESS_READ, Scopes.HEALTHKIT_STRESS_WRITE
        };
        ...
        if (requestCode == REQUEST_AUTH) {
            ...
            if (result.isSuccess()) {
                ...
                if (result.getAuthAccount() != null && result.getAuthAccount().getAuthorizedScopes() != null) {
                    ...
                    if (authorizedScopes.size() == scopeLength) {
...
//                        schedule(this);
    ...
    private void initView() {
        ...
        ImageView mAuthBackIcon = findViewById(R.id.health_auth_back_icon);
